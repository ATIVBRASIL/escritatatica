...
import { AdminPanel } from './AdminPanel'; // Importação do Novo Painel
    ...
    <div className="min-h-screen bg-[#050505] text-gray-200 font-sans">
      <header className="sticky top-0 z-50 bg-[#050505]/95 backdrop-blur-md border-b border-[#1C1C1E] px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          {/* BOTÃO DO COMANDANTE: Só aparece para o seu e-mail */}
          ...
          <a href="https://ativbrasil.com.br/" target="_blank" className="text-[10px] font-bold text-green-500 uppercase border border-green-500/30 px-2 py-1 rounded">Cursos</a>
